      ...
      <Container>
        ...
        <Form onSubmit={guardar}>
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control type="number" value={rating} onChange={cambioRating} />
          </Form.Group>
          <Form.Group className="mb-3">
            <Form.Label>Categoria:</Form.Label>
            <Form.Control type="text" value={categoria} onChange={cambioCategoria} />
          </Form.Group>
          <Form.Group className="mb-3">
            <Form.Label>Fecha:</Form.Label>
            <Form.Control type="date" value={fecha} onChange={cambioFecha} />
          </Form.Group>
